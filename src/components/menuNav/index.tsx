...
export default function MenuNav() {
    ...
    const { showNav, setShowNav } = layoutContext
    return (
        <div className="menu-nav">
            <div>
                <button className="flex items-center mb-10" onClick={() => { setShowNav(0); scroll('#contrato') }}>
                ...
                <button className="flex items-center mb-10" onClick={() => { setShowNav(1); scroll('#integracao') }}>
                ...
                <button className="flex items-center" onClick={() => { setShowNav(2); scroll('#criativo') }}>
